...
const ProductId: React.FC = () => {
  ...
  return (
    <div className="rounded w-full md:w-[80%] min-h-[90vh] bg-secundario-ligth dark:bg-fondo-dark m-auto flex flex-col gap-2 justify-between">
      <div className="flex flex-row gap-1 justify-between rounded-t bg-fondo-dark dark:bg-secundario p-1 text-texto-dark">
        {producto.nombre}
        <div>
          {isEditing ? (
            <div className="flex gap-2">
              <button
                ...
                className="text-[.8rem] hover:scale-105 hover:text-red-500"
              >
                <MdCancel />
              </button>
              <button
                onClick={handleSubmit}
                className="text-[.8rem] hover:scale-105 hover:text-green-500"
              >
                <GiConfirmed />
              </button>
            </div>
            ...
            <button
              ...
              className="text-[.8rem] hover:scale-105"
            >
              <FaEdit />
            </button>
          )}
      ...
      <div className="flex flex-col md:flex-row gap-2 justify-around items-start">
        <div>
