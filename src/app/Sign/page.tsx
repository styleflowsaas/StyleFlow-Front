...
const Sign: React.FC = () => {
  ...
  return (
    <section className="w-full md:w-2/3 lg:w-1/2 min-h-[90vh] mx-auto flex flex-col gap-4 items-center justify-center border border-main dark:border-none rounded-lg p-5 shadow-2xl dark:bg-secundario overflow-hidden ">
      <Logo />
